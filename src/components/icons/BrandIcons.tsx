// Gmail and Outlook use the providers' actual current mark geometry (traced
// from their official 2020/2019 icon redesigns) so they read correctly next
// to the real apps; iCloud and Yahoo are simplified, original vector marks
// that evoke their brand identity without reproducing logo artwork
// pixel-for-pixel.
...
export function OutlookIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 1831.085 1703.335" {...props}>
      <path
        fill="#0A2767"
      ...
      <path
        fill="url(#mailnext-outlook-grad-1)"
      ...
      <path
        fill="url(#mailnext-outlook-grad-2)"
  ...
  return (
    <svg viewBox="0 0 48 48" fill="none" {...props}>
      <path
        ...
        fill="url(#mailnext-icloud-gradient)"
      />
      <defs>
        <linearGradient id="mailnext-icloud-gradient" x1="6" y1="13" x2="38" y2="34" gradientUnits="userSpaceOnUse">
